...
#define AUDIO_CHANNEL_NONE_LIST_DEF(V) \
...
enum {
    ...
    // Can't use AUDIO_CHANNEL_REPRESENTATION_* because audio.h depends on this header.
    AUDIO_CHANNEL_INDEX_ACN = 0x40000000u, // AUDIO_CHANNEL_REPRESENTATION_ACN << COUNT_MAX
...
enum {
    AUDIO_ACN_MIN_ORDER = 0, /* 0 is 1 channel in both representations */
    AUDIO_ACN_MAX_ORDER = 14,
    AUDIO_ACN_CHANNEL_COUNT_MASK = (1 << 8) - 1,
    AUDIO_ACN_FULL_SPHERE = 0, /*default*/
    AUDIO_ACN_HORIZONTAL = 1 << 9,
    AUDIO_ACN_BIT_MASK = (1 << 10) - 1,
};

// Ambisonics ACN representation definitions.
// Goes from AUDIO_ACN_MIN_ORDER to AUDIO_ACN_MAX_ORDER.
#define AUDIO_CHANNEL_ACN_ORDER_MASK_LIST_DEF(V) \
    V(AUDIO_CHANNEL_ACN_ORDER_0, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 1) \
    V(AUDIO_CHANNEL_ACN_ORDER_1, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 4) \
    V(AUDIO_CHANNEL_ACN_ORDER_2, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 9) \
    V(AUDIO_CHANNEL_ACN_ORDER_3, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 16) \
    V(AUDIO_CHANNEL_ACN_ORDER_4, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 25) \
    V(AUDIO_CHANNEL_ACN_ORDER_5, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 36) \
    V(AUDIO_CHANNEL_ACN_ORDER_6, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 49) \
    V(AUDIO_CHANNEL_ACN_ORDER_7, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 64) \
    V(AUDIO_CHANNEL_ACN_ORDER_8, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 81) \
    V(AUDIO_CHANNEL_ACN_ORDER_9, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 100) \
    V(AUDIO_CHANNEL_ACN_ORDER_10, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 121) \
    V(AUDIO_CHANNEL_ACN_ORDER_11, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 144) \
    V(AUDIO_CHANNEL_ACN_ORDER_12, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 169) \
    V(AUDIO_CHANNEL_ACN_ORDER_13, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 196) \
    V(AUDIO_CHANNEL_ACN_ORDER_14, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_FULL_SPHERE | 225) \
    V(AUDIO_CHANNEL_ACN_ORDER_0_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 1) \
    V(AUDIO_CHANNEL_ACN_ORDER_1_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 3) \
    V(AUDIO_CHANNEL_ACN_ORDER_2_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 5) \
    V(AUDIO_CHANNEL_ACN_ORDER_3_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 7) \
    V(AUDIO_CHANNEL_ACN_ORDER_4_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 9) \
    V(AUDIO_CHANNEL_ACN_ORDER_5_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 11) \
    V(AUDIO_CHANNEL_ACN_ORDER_6_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 13) \
    V(AUDIO_CHANNEL_ACN_ORDER_7_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 15) \
    V(AUDIO_CHANNEL_ACN_ORDER_8_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 17) \
    V(AUDIO_CHANNEL_ACN_ORDER_9_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 19) \
    V(AUDIO_CHANNEL_ACN_ORDER_10_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 21) \
    V(AUDIO_CHANNEL_ACN_ORDER_11_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 23) \
    V(AUDIO_CHANNEL_ACN_ORDER_12_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 25) \
    V(AUDIO_CHANNEL_ACN_ORDER_13_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 27) \
    V(AUDIO_CHANNEL_ACN_ORDER_14_HRZ, AUDIO_CHANNEL_INDEX_ACN | AUDIO_ACN_HORIZONTAL | 29)
...
typedef enum : uint32_t {
    ...
    AUDIO_CHANNEL_NONE_LIST_DEF(AUDIO_DEFINE_ENUM_SYMBOL_V)
    ...
    AUDIO_CHANNEL_ACN_ORDER_MASK_LIST_DEF(AUDIO_DEFINE_ENUM_SYMBOL_V)
...
inline const char* audio_channel_out_mask_to_string(audio_channel_mask_t t) {
    switch (t) {
    AUDIO_CHANNEL_NONE_LIST_DEF(AUDIO_DEFINE_STRINGIFY_CASE_V)
...
inline const char* audio_channel_acn_mask_to_string(audio_channel_mask_t t) {
    switch (t) {
    AUDIO_CHANNEL_NONE_LIST_DEF(AUDIO_DEFINE_STRINGIFY_CASE_V)
    AUDIO_CHANNEL_ACN_ORDER_MASK_LIST_DEF(AUDIO_DEFINE_STRINGIFY_CASE_V)
    default:
        return "";
    }
}
...
inline bool audio_channel_mask_from_string(const char* s, audio_channel_mask_t* t) {
    AUDIO_CHANNEL_NONE_LIST_DEF(AUDIO_DEFINE_PARSE_CASE_V)
    ...
    AUDIO_CHANNEL_ACN_ORDER_MASK_LIST_DEF(AUDIO_DEFINE_PARSE_CASE_V)
    return false;
}

#undef AUDIO_CHANNEL_ACN_ORDER_MASK_LIST_DEF
...
#undef AUDIO_CHANNEL_NONE_LIST_DEF
...
#define AUDIO_DEVICE_LIST_UNIQUE_DEF(V) \
    ...
    V(AUDIO_DEVICE_OUT_BLE_HEARING_AID, 0x20000004u) \
    V(AUDIO_DEVICE_OUT_BLE_CENTRAL, 0x20000008u) \
    ...
    V(AUDIO_DEVICE_IN_BLE_HEARING_AID, AUDIO_DEVICE_BIT_IN | 0x20000001u) \
    V(AUDIO_DEVICE_IN_BLE_CENTRAL, AUDIO_DEVICE_BIT_IN | 0x20000002u) \
    V(AUDIO_DEVICE_IN_BLE_CENTRAL_BROADCAST, AUDIO_DEVICE_BIT_IN | 0x20000004u) \
...
#define AUDIO_FORMAT_LIST_UNIQUE_DEF(V) \
    ...
    V(AUDIO_FORMAT_APTX_ADAPTIVE_PLUS, 0x35000000u)
...
#define AUDIO_USAGE_LIST_NO_SYS_DEF(V) \
    ...
    V(AUDIO_USAGE_NOTIFICATION_VIBRATION, 1005) \
    V(AUDIO_USAGE_RINGTONE_VIBRATION, 1006)
#ifdef AUDIO_NO_SYSTEM_DECLARATIONS
